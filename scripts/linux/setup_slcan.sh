...
# Usage: sudo bash scripts/linux/setup_slcan.sh [serial_port=/dev/ttyACM0] [iface_name=can0]
...
echo "OK: ${IFACE} @1Mbps (${DEV}). Verify with: candump ${IFACE}; or maker-arm scan --channel ${IFACE}"
