...
⚠️ The motor must already be switched to the MIT protocol (switch_protocol.py --to mit + power-cycle).
⚠️ This tool uses lerobot's RobstrideMotorsBus — run it in the metal-lerobot environment:
    ~/miniconda3/envs/metal-lerobot/bin/python tools/experimental/lerobot/mit_move.py --id 127 --delta 15
"""
